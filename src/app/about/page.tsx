...
import { Calendar, Users, BookOpen, Award, FileText, GraduationCap, Briefcase, Code, Cpu, ChevronRight } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24">
              {/* Sidebar Navigation */}
              <nav className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
                  ...
                  {sidebarLinks.map((link) => (
                    <li key={link.href}>
                      ...
                      >
                        ...
                        <ChevronRight className={`h-4 w-4 ${pathname === link.href ? 'text-blue-500' : 'text-gray-400'}`} />
                      </Link>
                    </li>
                  ))}
                </ul>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg shadow-sm border border-blue-100 p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Teaching Inquiries</h3>
                <p className="text-sm text-gray-600 mb-4">
                  Interested in research mentorship or academic collaboration?
                </p>
                <a
                  href="mailto:abenezertaye@gvu.edu"
                  className="inline-flex items-center justify-center w-full px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors text-sm font-medium"
                >
          ...
          <div className="lg:col-span-3">
            ...
            <section className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg shadow-sm border border-blue-100 p-8">
